...
alias cdpw="cd ~/Documents/Programming/workshop"
alias cdpi="cd ~/Pictures"
alias cdd="cd ~/Documents"
alias cda="cd ~/Documents/Film"
alias cdf="cd ~/Documents/Finance"
alias cddo="cd ~/Downloads"
alias cdw="cd ~/Documents/Sync/Work"
...
alias vrc="open ~/.vimrc"
alias nvrc="open ~/.config/nvim/init.lua"
alias cls="clear"
alias ls="ls --color=auto --group-directories-first"
alias lsp='for file in *.pdf ; do pages=$(pdfinfo "$file" | awk "/Pages/{print $2}"); echo "$file $pages pages"; done'
alias lsg="ls | grep"
alias py="python3.12"
